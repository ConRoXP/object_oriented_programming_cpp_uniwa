...
/*
A more correct solution would be with the use of std:vector but I hadn't learnt that yet.  
This here is a "hands-on" implementation by directly managing the memory.  
*/
